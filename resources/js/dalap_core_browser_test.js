...
dalap.selector.match_selector = function(a, b) {
  var c = dalap.selector.span.call(null, cljs.core.complement.call(null, a), b), d = cljs.core.nth.call(null, c, 0, null), c = cljs.core.nth.call(null, c, 1, null), e = cljs.core.nth.call(null, c, 0, null);
...
cljs.core.PersistentVector.prototype.dalap$selector$TreeLocMatcher$to_tree_loc_matcher$arity$1 = function(a) {
  var b = cljs.core.map.call(null, dalap.selector.to_node_matcher, a);
  return function(c, d) {
    var e = (new cljs.core.Keyword("\ufdd0'history")).call(null, d);
    console.log([cljs.core.str("node: "), cljs.core.str(c), cljs.core.str(" hist: "), cljs.core.str(e), cljs.core.str("\n selector "), cljs.core.str(a)].join(""));
...
buster.spec.describe("test-vector-as-a-selector", function() {
  buster.spec.it("with vectors as selector on rules", function() {
    var a = cljs.core.PersistentVector.fromArray([cljs.core.vector_QMARK_, "\ufdd1'some"], !0), a = cljs.core.PersistentVector.fromArray([a, "\ufdd1'replacement"], !0), a = dalap.selector.gen_visitor.call(null, a, dalap.test.selector.visit_clj_form);
    dalap.test.selector.assert_walk.call(null, a, cljs.core.PersistentVector.fromArray([1, 2, cljs.core.PersistentVector.fromArray(["\ufdd1'some"], !0), "other value"], !0), cljs.core.PersistentVector.fromArray([1, 2, cljs.core.PersistentVector.fromArray(["\ufdd1'replacement"], !0), "other value"], !0));
    return null
  });
  return null
});
