...
dalap.selector.to_tree_loc_matcher = function(a) {
  if(a ? a.dalap$selector$TreeLocMatcher$to_tree_loc_matcher$arity$1 : a) {
    return a.dalap$selector$TreeLocMatcher$to_tree_loc_matcher$arity$1(a)
  }
  var b;
  b = dalap.selector.to_tree_loc_matcher[goog.typeOf(null == a ? null : a)];
  if(!b && (b = dalap.selector.to_tree_loc_matcher._, !b)) {
    throw cljs.core.missing_protocol.call(null, "TreeLocMatcher.to-tree-loc-matcher", a);
  }
  return b.call(null, a)
};
...
dalap.selector.match_selector = function(a, b) {
...
dalap.selector.match_selector_STAR_ = function(a, b) {
  for(var c = b, d = cljs.core.first.call(null, a), e = cljs.core.rest.call(null, a);;) {
    d = dalap.selector.match_selector.call(null, d, c);
...
dalap.selector.matching_node = function(a, b) {
  return cljs.core.first.call(null, dalap.selector.match_selector_STAR_.call(null, a, b))
};
dalap.selector.TreeLocMatcher["function"] = !0;
dalap.selector.to_tree_loc_matcher["function"] = function(a) {
  return a
};
dalap.selector.TreeLocMatcher.string = !0;
dalap.selector.to_tree_loc_matcher.string = function(a) {
...
cljs.core.PersistentVector.prototype.dalap$selector$TreeLocMatcher$ = !0;
cljs.core.PersistentVector.prototype.dalap$selector$TreeLocMatcher$to_tree_loc_matcher$arity$1 = function(a) {
  var b = cljs.core.map.call(null, dalap.selector.to_tree_loc_matcher, a);
  return function(a, d) {
    var e = (new cljs.core.Keyword("\ufdd0'history")).call(null, d);
    return dalap.selector.matching_node.call(null, b, e)
  }
};
dalap.selector.IAdaptToVisitor = {};
dalap.selector.to_visitor = function(a) {
  if(a ? a.dalap$selector$IAdaptToVisitor$to_visitor$arity$1 : a) {
    return a.dalap$selector$IAdaptToVisitor$to_visitor$arity$1(a)
  }
  var b;
  b = dalap.selector.to_visitor[goog.typeOf(null == a ? null : a)];
  if(!b && (b = dalap.selector.to_visitor._, !b)) {
    throw cljs.core.missing_protocol.call(null, "IAdaptToVisitor.to-visitor", a);
  }
  return b.call(null, a)
};
cljs.core.PersistentHashMap.prototype.dalap$selector$IAdaptToVisitor$ = !0;
cljs.core.PersistentHashMap.prototype.dalap$selector$IAdaptToVisitor$to_visitor$arity$1 = function(a) {
  return function(b) {
    return a.call(null, b)
  }
};
dalap.selector.ifn_to_visitor = function(a) {
  return function(b) {
    return a.call(null, b)
  }
};
dalap.selector.IAdaptToVisitor["function"] = !0;
dalap.selector.to_visitor["function"] = function(a) {
  return dalap.selector.ifn_to_visitor.call(null, a)
};
dalap.selector.IAdaptToVisitor._ = !0;
dalap.selector.to_visitor._ = function(a) {
  return function() {
    return a
  }
};
dalap.selector.IAdaptToVisitor.string = !0;
dalap.selector.to_visitor.string = function(a) {
...
cljs.core.PersistentVector.prototype.dalap$selector$IAdaptToVisitor$ = !0;
cljs.core.PersistentVector.prototype.dalap$selector$IAdaptToVisitor$to_visitor$arity$1 = function(a) {
  return function() {
    return a
  }
};
dalap.selector.gen_visitor_from_pred_visitor_pairs = function(a, b) {
  return function(c, d) {
    return cljs.core.truth_(b.call(null, c)) ? function() {
      var b = cljs.core.some.call(null, function(a) {
        var b = cljs.core.nth.call(null, a, 0, null), a = cljs.core.nth.call(null, a, 1, null);
        return cljs.core.truth_(b.call(null, c, d)) ? a : null
      }, a);
      return cljs.core.truth_(b) ? b : cljs.core.constantly.call(null, c)
    }().call(null, c, d) : c
  }
};
dalap.selector.normalize_selector_transformer_pairs = function(a) {
  return function c(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var e = cljs.core.first.call(null, a), f = cljs.core.nth.call(null, e, 0, null), e = cljs.core.nth.call(null, e, 1, null);
          return cljs.core.cons.call(null, cljs.core.PersistentVector.fromArray([dalap.selector.to_tree_loc_matcher.call(null, f), dalap.selector.to_visitor.call(null, e)], true), c.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    }, null)
...
dalap.selector._gen_decorator = function(a) {
  var b = cljs.core.identity, a = cljs.core.partition.call(null, 2, a), c = dalap.selector.gen_visitor_from_pred_visitor_pairs.call(null, dalap.selector.normalize_selector_transformer_pairs.call(null, a), b), d = function(a, c) {
...
buster.spec.describe("test-walk-with-no-rules", function() {
  buster.spec.it("without any rules on visit", function() {
    var a = cljs.core.with_meta(cljs.core.list("\ufdd1'let", cljs.core.vec(["\ufdd1'hello", "hola"]), cljs.core.with_meta(cljs.core.list("\ufdd1'str", "\ufdd1'hello"), cljs.core.hash_map("\ufdd0'line", 12))), cljs.core.hash_map("\ufdd0'line", 12)), b = dalap.selector.gen_visitor.call(null, cljs.core.PersistentVector.EMPTY, dalap.test.selector_test.visit_clj_form);
...
buster.spec.describe("test-symbol-as-a-selector", function() {
  buster.spec.it("with symbol as a selector on rules", function() {
    var a = cljs.core.PersistentVector.fromArray(["\ufdd1'hello", "\ufdd1'hallo"], !0), a = dalap.selector.gen_visitor.call(null, a, dalap.test.selector_test.visit_clj_form);
...
buster.spec.describe("test-function-as-a-selector", function() {
  buster.spec.it("with functions as a selector on rules", function() {
    ...
    }, "Something Else"], !0), a = dalap.selector.gen_visitor.call(null, a, dalap.test.selector_test.visit_clj_form);
...
buster.spec.describe("test-walking-over-a-set", function() {
  buster.spec.it("with set as the collection we are visiting", function() {
    var a = cljs.core.PersistentVector.fromArray(["\ufdd1'foo", 999], !0), a = dalap.selector.gen_visitor.call(null, a, dalap.test.selector_test.visit_clj_form);
...
buster.spec.describe("test-vector-as-a-selector", function() {
  buster.spec.it("with vectors as selector on rules", function() {
    var a = cljs.core.PersistentVector.fromArray([function(a) {
      return cljs.core.vector_QMARK_.call(null, a)
    }, "\ufdd1'foobar"], !0), a = cljs.core.PersistentVector.fromArray([a, "\ufdd1'replacement"], !0), a = dalap.selector.gen_visitor.call(null, a, dalap.test.selector_test.visit_clj_form);
...
dalap.test.selector.CustomType.prototype.cljs$core$IHash$_hash$arity$1 = function(a) {
  var b = this.__hash;
  return null != b ? b : this.__hash = a = cljs.core.hash_imap.call(null, a)
};
dalap.test.selector.CustomType.prototype.cljs$core$ILookup$_lookup$arity$2 = function(a, b) {
  return a.cljs$core$ILookup$_lookup$arity$3(a, b, null)
};
dalap.test.selector.CustomType.prototype.cljs$core$ILookup$_lookup$arity$3 = function(a, b, c) {
  return"\ufdd0'a" === b ? this.a : "\ufdd0'b" === b ? this.b : cljs.core._lookup.call(null, this.__extmap, b, c)
};
dalap.test.selector.CustomType.prototype.cljs$core$IAssociative$_assoc$arity$3 = function(a, b, c) {
  a = cljs.core.identical_QMARK_;
  return a.call(null, "\ufdd0'a", b) ? new dalap.test.selector.CustomType(c, this.b, this.__meta, this.__extmap, null) : a.call(null, "\ufdd0'b", b) ? new dalap.test.selector.CustomType(this.a, c, this.__meta, this.__extmap, null) : new dalap.test.selector.CustomType(this.a, this.b, this.__meta, cljs.core.assoc.call(null, this.__extmap, b, c), null)
};
dalap.test.selector.CustomType.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = function(a, b, c) {
  return cljs.core.pr_sequential_writer.call(null, b, function(a) {
    return cljs.core.pr_sequential_writer.call(null, b, cljs.core.pr_writer, "", " ", "", c, a)
  }, [cljs.core.str("#"), cljs.core.str("CustomType"), cljs.core.str("{")].join(""), ", ", "}", c, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'a", this.a), cljs.core.vector.call(null, "\ufdd0'b", this.b)], !0), this.__extmap))
};
dalap.test.selector.CustomType.prototype.cljs$core$ICollection$_conj$arity$2 = function(a, b) {
  return cljs.core.vector_QMARK_.call(null, b) ? a.cljs$core$IAssociative$_assoc$arity$3(a, cljs.core._nth.call(null, b, 0), cljs.core._nth.call(null, b, 1)) : cljs.core.reduce.call(null, cljs.core._conj, a, b)
};
dalap.test.selector.CustomType.prototype.cljs$core$ISeqable$_seq$arity$1 = function() {
  return cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'a", this.a), cljs.core.vector.call(null, "\ufdd0'b", this.b)], !0), this.__extmap))
};
dalap.test.selector.CustomType.prototype.cljs$core$ICounted$_count$arity$1 = function() {
  return 2 + cljs.core.count.call(null, this.__extmap)
};
dalap.test.selector.CustomType.prototype.cljs$core$IEquiv$_equiv$arity$2 = function(a, b) {
  return cljs.core.truth_(function() {
    if(cljs.core.truth_(b)) {
      var c = a.constructor === b.constructor;
      return c ? cljs.core.equiv_map.call(null, a, b) : c
...
dalap.test.selector.CustomType.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
  return new dalap.test.selector.CustomType(this.a, this.b, b, this.__extmap, this.__hash)
};
dalap.test.selector.CustomType.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
  return this.__meta
};
dalap.test.selector.CustomType.prototype.cljs$core$IMap$_dissoc$arity$2 = function(a, b) {
  return cljs.core.contains_QMARK_.call(null, cljs.core.PersistentHashSet.fromArray(["\ufdd0'a", "\ufdd0'b"]), b) ? cljs.core.dissoc.call(null, cljs.core.with_meta.call(null, cljs.core.into.call(null, cljs.core.ObjMap.EMPTY, a), this.__meta), b) : new dalap.test.selector.CustomType(this.a, this.b, this.__meta, cljs.core.not_empty.call(null, cljs.core.dissoc.call(null, this.__extmap, b)), null)
};
dalap.test.selector.CustomType.cljs$lang$type = !0;
dalap.test.selector.CustomType.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "dalap.test.selector/CustomType")
};
dalap.test.selector.CustomType.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "dalap.test.selector/CustomType")
};
dalap.test.selector.__GT_CustomType = function(a, b) {
  return new dalap.test.selector.CustomType(a, b)
};
dalap.test.selector.map__GT_CustomType = function(a) {
  return new dalap.test.selector.CustomType((new cljs.core.Keyword("\ufdd0'a")).call(null, a), (new cljs.core.Keyword("\ufdd0'b")).call(null, a), null, cljs.core.dissoc.call(null, a, "\ufdd0'a", "\ufdd0'b"))
};
dalap.test.selector.CustomType;
dalap.test.selector.CustomType2 = function(a, b, c, d) {
  this.a = a;
  this.b = b;
  this.__meta = c;
  this.__extmap = d;
...
dalap.test.selector.CustomType2.prototype.cljs$core$IHash$_hash$arity$1 = function(a) {
  var b = this.__hash;
  return null != b ? b : this.__hash = a = cljs.core.hash_imap.call(null, a)
};
dalap.test.selector.CustomType2.prototype.cljs$core$ILookup$_lookup$arity$2 = function(a, b) {
  return a.cljs$core$ILookup$_lookup$arity$3(a, b, null)
};
dalap.test.selector.CustomType2.prototype.cljs$core$ILookup$_lookup$arity$3 = function(a, b, c) {
  return"\ufdd0'a" === b ? this.a : "\ufdd0'b" === b ? this.b : cljs.core._lookup.call(null, this.__extmap, b, c)
};
dalap.test.selector.CustomType2.prototype.cljs$core$IAssociative$_assoc$arity$3 = function(a, b, c) {
  a = cljs.core.identical_QMARK_;
  return a.call(null, "\ufdd0'a", b) ? new dalap.test.selector.CustomType2(c, this.b, this.__meta, this.__extmap, null) : a.call(null, "\ufdd0'b", b) ? new dalap.test.selector.CustomType2(this.a, c, this.__meta, this.__extmap, null) : new dalap.test.selector.CustomType2(this.a, this.b, this.__meta, cljs.core.assoc.call(null, this.__extmap, b, c), null)
};
dalap.test.selector.CustomType2.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = function(a, b, c) {
  return cljs.core.pr_sequential_writer.call(null, b, function(a) {
    return cljs.core.pr_sequential_writer.call(null, b, cljs.core.pr_writer, "", " ", "", c, a)
  }, [cljs.core.str("#"), cljs.core.str("CustomType2"), cljs.core.str("{")].join(""), ", ", "}", c, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'a", this.a), cljs.core.vector.call(null, "\ufdd0'b", this.b)], !0), this.__extmap))
};
dalap.test.selector.CustomType2.prototype.cljs$core$ICollection$_conj$arity$2 = function(a, b) {
  return cljs.core.vector_QMARK_.call(null, b) ? a.cljs$core$IAssociative$_assoc$arity$3(a, cljs.core._nth.call(null, b, 0), cljs.core._nth.call(null, b, 1)) : cljs.core.reduce.call(null, cljs.core._conj, a, b)
};
dalap.test.selector.CustomType2.prototype.cljs$core$ISeqable$_seq$arity$1 = function() {
  return cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'a", this.a), cljs.core.vector.call(null, "\ufdd0'b", this.b)], !0), this.__extmap))
};
dalap.test.selector.CustomType2.prototype.cljs$core$ICounted$_count$arity$1 = function() {
  return 2 + cljs.core.count.call(null, this.__extmap)
};
dalap.test.selector.CustomType2.prototype.cljs$core$IEquiv$_equiv$arity$2 = function(a, b) {
  return cljs.core.truth_(function() {
    if(cljs.core.truth_(b)) {
      var c = a.constructor === b.constructor;
      return c ? cljs.core.equiv_map.call(null, a, b) : c
...
dalap.test.selector.CustomType2.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
  return new dalap.test.selector.CustomType2(this.a, this.b, b, this.__extmap, this.__hash)
};
dalap.test.selector.CustomType2.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
  return this.__meta
};
dalap.test.selector.CustomType2.prototype.cljs$core$IMap$_dissoc$arity$2 = function(a, b) {
  return cljs.core.contains_QMARK_.call(null, cljs.core.PersistentHashSet.fromArray(["\ufdd0'a", "\ufdd0'b"]), b) ? cljs.core.dissoc.call(null, cljs.core.with_meta.call(null, cljs.core.into.call(null, cljs.core.ObjMap.EMPTY, a), this.__meta), b) : new dalap.test.selector.CustomType2(this.a, this.b, this.__meta, cljs.core.not_empty.call(null, cljs.core.dissoc.call(null, this.__extmap, b)), null)
};
dalap.test.selector.CustomType2.cljs$lang$type = !0;
dalap.test.selector.CustomType2.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "dalap.test.selector/CustomType2")
};
dalap.test.selector.CustomType2.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "dalap.test.selector/CustomType2")
};
dalap.test.selector.__GT_CustomType2 = function(a, b) {
  return new dalap.test.selector.CustomType2(a, b)
};
dalap.test.selector.map__GT_CustomType2 = function(a) {
  return new dalap.test.selector.CustomType2((new cljs.core.Keyword("\ufdd0'a")).call(null, a), (new cljs.core.Keyword("\ufdd0'b")).call(null, a), null, cljs.core.dissoc.call(null, a, "\ufdd0'a", "\ufdd0'b"))
};
dalap.test.selector.CustomType2;
dalap.test.selector.CustomType3 = function(a, b, c, d) {
  this.a = a;
  this.b = b;
  this.__meta = c;
  this.__extmap = d;
...
dalap.test.selector.CustomType3.prototype.cljs$core$IHash$_hash$arity$1 = function(a) {
  var b = this.__hash;
  return null != b ? b : this.__hash = a = cljs.core.hash_imap.call(null, a)
};
dalap.test.selector.CustomType3.prototype.cljs$core$ILookup$_lookup$arity$2 = function(a, b) {
  return a.cljs$core$ILookup$_lookup$arity$3(a, b, null)
};
dalap.test.selector.CustomType3.prototype.cljs$core$ILookup$_lookup$arity$3 = function(a, b, c) {
  return"\ufdd0'a" === b ? this.a : "\ufdd0'b" === b ? this.b : cljs.core._lookup.call(null, this.__extmap, b, c)
};
dalap.test.selector.CustomType3.prototype.cljs$core$IAssociative$_assoc$arity$3 = function(a, b, c) {
  a = cljs.core.identical_QMARK_;
  return a.call(null, "\ufdd0'a", b) ? new dalap.test.selector.CustomType3(c, this.b, this.__meta, this.__extmap, null) : a.call(null, "\ufdd0'b", b) ? new dalap.test.selector.CustomType3(this.a, c, this.__meta, this.__extmap, null) : new dalap.test.selector.CustomType3(this.a, this.b, this.__meta, cljs.core.assoc.call(null, this.__extmap, b, c), null)
};
dalap.test.selector.CustomType3.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = function(a, b, c) {
  return cljs.core.pr_sequential_writer.call(null, b, function(a) {
    return cljs.core.pr_sequential_writer.call(null, b, cljs.core.pr_writer, "", " ", "", c, a)
  }, [cljs.core.str("#"), cljs.core.str("CustomType3"), cljs.core.str("{")].join(""), ", ", "}", c, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'a", this.a), cljs.core.vector.call(null, "\ufdd0'b", this.b)], !0), this.__extmap))
};
dalap.test.selector.CustomType3.prototype.cljs$core$ICollection$_conj$arity$2 = function(a, b) {
  return cljs.core.vector_QMARK_.call(null, b) ? a.cljs$core$IAssociative$_assoc$arity$3(a, cljs.core._nth.call(null, b, 0), cljs.core._nth.call(null, b, 1)) : cljs.core.reduce.call(null, cljs.core._conj, a, b)
};
dalap.test.selector.CustomType3.prototype.cljs$core$ISeqable$_seq$arity$1 = function() {
  return cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'a", this.a), cljs.core.vector.call(null, "\ufdd0'b", this.b)], !0), this.__extmap))
};
dalap.test.selector.CustomType3.prototype.cljs$core$ICounted$_count$arity$1 = function() {
  return 2 + cljs.core.count.call(null, this.__extmap)
};
dalap.test.selector.CustomType3.prototype.cljs$core$IEquiv$_equiv$arity$2 = function(a, b) {
  return cljs.core.truth_(function() {
    if(cljs.core.truth_(b)) {
      var c = a.constructor === b.constructor;
      return c ? cljs.core.equiv_map.call(null, a, b) : c
...
dalap.test.selector.CustomType3.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
  return new dalap.test.selector.CustomType3(this.a, this.b, b, this.__extmap, this.__hash)
};
dalap.test.selector.CustomType3.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
  return this.__meta
};
dalap.test.selector.CustomType3.prototype.cljs$core$IMap$_dissoc$arity$2 = function(a, b) {
  return cljs.core.contains_QMARK_.call(null, cljs.core.PersistentHashSet.fromArray(["\ufdd0'a", "\ufdd0'b"]), b) ? cljs.core.dissoc.call(null, cljs.core.with_meta.call(null, cljs.core.into.call(null, cljs.core.ObjMap.EMPTY, a), this.__meta), b) : new dalap.test.selector.CustomType3(this.a, this.b, this.__meta, cljs.core.not_empty.call(null, cljs.core.dissoc.call(null, this.__extmap, b)), null)
};
dalap.test.selector.CustomType3.cljs$lang$type = !0;
dalap.test.selector.CustomType3.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "dalap.test.selector/CustomType3")
};
dalap.test.selector.CustomType3.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "dalap.test.selector/CustomType3")
};
dalap.test.selector.__GT_CustomType3 = function(a, b) {
  return new dalap.test.selector.CustomType3(a, b)
};
dalap.test.selector.map__GT_CustomType3 = function(a) {
  return new dalap.test.selector.CustomType3((new cljs.core.Keyword("\ufdd0'a")).call(null, a), (new cljs.core.Keyword("\ufdd0'b")).call(null, a), null, cljs.core.dissoc.call(null, a, "\ufdd0'a", "\ufdd0'b"))
};
dalap.test.selector.CustomType3;
dalap.test.selector.CustomType4 = function(a, b) {
  this.a = a;
  this.b = b
};
dalap.test.selector.CustomType4.cljs$lang$type = !0;
dalap.test.selector.CustomType4.cljs$lang$ctorPrSeq = function() {
  return cljs.core.list.call(null, "dalap.test.selector/CustomType4")
};
dalap.test.selector.CustomType4.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "dalap.test.selector/CustomType4")
};
dalap.test.selector.CustomType4;
dalap.test.selector.visit_clj_form = function(a, b) {
  var c = function(a, b) {
    return cljs.core.remove.call(null, function(a) {
      return cljs.core._EQ_.call(null, a, cljs.core.keyword.call(null, "dalap/form"))
    }, cljs.core.map.call(null, a, b))
...
dalap.test.selector.assert_walk = function() {
  var a = function(a, b, e, f) {
    f = cljs.core.nth.call(null, f, 0, null);
    a = dalap.walk.walk.call(null, b, a);
    return buster_cljs.core.is.call(null, cljs.core._EQ_.call(null, a, e), [cljs.core.str(cljs.core.truth_(f) ? [cljs.core.str(f), cljs.core.str(" -- ")].join("") : f), cljs.core.str("expected: "), cljs.core.str(cljs.core.pr_str.call(null, e)), cljs.core.str(" -- "), cljs.core.str("got: "), cljs.core.str(cljs.core.pr_str.call(null, a))].join(""))
...
buster.spec.describe("test-walk-with-no-rules", function() {
  buster.spec.it("without any rules on visit", function() {
    var a = cljs.core.with_meta(cljs.core.list("\ufdd1'let", cljs.core.vec(["\ufdd1'hello", "hola"]), cljs.core.with_meta(cljs.core.list("\ufdd1'str", "\ufdd1'hello"), cljs.core.hash_map("\ufdd0'line", 12))), cljs.core.hash_map("\ufdd0'line", 12)), b = dalap.selector.gen_visitor.call(null, cljs.core.PersistentVector.EMPTY, dalap.test.selector.visit_clj_form);
    dalap.test.selector.assert_walk.call(null, b, a, a, "should be same value");
    return null
  });
  return null
});
buster.spec.describe("test-symbol-as-a-selector", function() {
  buster.spec.it("with symbol as a selector on rules", function() {
    var a = cljs.core.PersistentVector.fromArray(["\ufdd1'hello", "\ufdd1'hallo"], !0), a = dalap.selector.gen_visitor.call(null, a, dalap.test.selector.visit_clj_form);
    dalap.test.selector.assert_walk.call(null, a, cljs.core.with_meta(cljs.core.list("\ufdd1'let", cljs.core.vec(["\ufdd1'hello", "hola"]), cljs.core.with_meta(cljs.core.list("\ufdd1'str", "\ufdd1'hello"), cljs.core.hash_map("\ufdd0'line", 13))), cljs.core.hash_map("\ufdd0'line", 13)), cljs.core.with_meta(cljs.core.list("\ufdd1'let", cljs.core.vec(["\ufdd1'hallo", "hola"]), cljs.core.with_meta(cljs.core.list("\ufdd1'str", "\ufdd1'hallo"), cljs.core.hash_map("\ufdd0'line", 13))), cljs.core.hash_map("\ufdd0'line", 
    13)));
    return null
  });
  return null
...
buster.spec.describe("test-function-as-a-selector", function() {
  buster.spec.it("with functions as a selector on rules", function() {
    var a = cljs.core.PersistentVector.fromArray([function(a) {
      return cljs.core.vector_QMARK_.call(null, a)
    }, "Something Else"], !0), a = dalap.selector.gen_visitor.call(null, a, dalap.test.selector.visit_clj_form);
    dalap.test.selector.assert_walk.call(null, a, cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.list.call(null, cljs.core.apply.call(null, cljs.core.vector, cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.list.call(null, "uno"), cljs.core.list.call(null, 2))))), cljs.core.list.call(null, cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.list.call(null, "\ufdd1'user/foobar")))))), cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.list.call(null, 
    "Something Else"), cljs.core.list.call(null, cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.list.call(null, "\ufdd1'user/foobar")))))));
    return null
  });
...
buster.spec.describe("test-walking-over-a-set", function() {
  buster.spec.it("with set as the collection we are visiting", function() {
    var a = cljs.core.PersistentVector.fromArray(["\ufdd1'foo", 999], !0), a = dalap.selector.gen_visitor.call(null, a, dalap.test.selector.visit_clj_form);
    dalap.test.selector.assert_walk.call(null, a, cljs.core.PersistentHashSet.fromArray(["\ufdd1'foo", "\ufdd1'hello"]), cljs.core.PersistentHashSet.fromArray([999, "\ufdd1'hello"]), "visitor should be able to walk on sets");
    return null
  });
  return null
});
buster.spec.describe("test-vector-as-a-selector", function() {
  buster.spec.it("with vectors as selector on rules", function() {
    var a = cljs.core.PersistentVector.fromArray([function(a) {
      return cljs.core.vector_QMARK_.call(null, a)
    }, "\ufdd1'foobar"], !0), a = cljs.core.PersistentVector.fromArray([a, "\ufdd1'replacement"], !0), a = dalap.selector.gen_visitor.call(null, a, dalap.test.selector.visit_clj_form);
    dalap.test.selector.assert_walk.call(null, a, cljs.core.PersistentVector.fromArray([1, 2, cljs.core.PersistentVector.fromArray(["\ufdd1'foobar"], !0), "other value"], !0), cljs.core.PersistentVector.fromArray([1, 2, cljs.core.PersistentVector.fromArray(["\ufdd1'replacement"], !0), "other value"], !0));
    return null
  });
  return null
});
