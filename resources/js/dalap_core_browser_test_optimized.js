    ...
    if(t(Vc.b ? Vc.b(b) : Vc.call(l, b))) {
      var d = function() {
        var d = Uc(function(a) {
          ...
          return t(d.a ? d.a(b, c) : d.call(l, b, c)) ? a : l
        }, a);
        return t(d) ? d : Xc(b)
      }();
...
buster.spec.describe("test-walker-constructors", function() {
  buster.spec.it("various walker constructors work identically", function() {
    for(var a = D(T([new Hf(Wf, Zd), If.b(Wf), If.a(Wf, Zd)]));;) {
      if(a) {
        var b = E(a);
        Uf.e(vb.a(1, b.b ? b.b(1) : b.call(l, 1)), I(["1"], 0));
        Uf.e(vb.a(Df(b), Zd), I(["2"], 0));
        Uf.e(function() {
          var a = b;
          return a ? t(t(l) ? l : a.$b) ? g : a.vc ? m : u(Cf, a) : u(Cf, a)
        }(), I(["3"], 0));
        Uf.e(vb.a(b.xa, Wf), I(["4"], 0));
        a = H(a)
      }else {
        break
      }
...
buster.spec.describe("test-walker-state-management", function() {
  buster.spec.it("manages state correctly", function() {
    for(var a = D(T([Zd, $d(["\ufdd0'a"], {"\ufdd0'a":1234}), $d(["\ufdd0'a", "\ufdd0'b"], {"\ufdd0'a":1234, "\ufdd0'b":99})]));;) {
      if(a) {
        var b = E(a), c = If.a(Wf, b);
        Uf(vb.a(Df(c), b));
        var d = Gf(c, $d(["\ufdd0'c"], {"\ufdd0'c":12}));
        Uf.e((new Ac("\ufdd0'c")).call(l, d), I([12], 0));
        Rc.a(c, d);
        Vf(Ef(d, function() {
          return function(a) {
            return Nb.a(a, "\ufdd0'c")
        ...
        Vf(Gf(d, $d(["\ufdd0'd", "\ufdd0'e"], {"\ufdd0'd":1, "\ufdd0'e":2})), Ef(d, function() {
          return function(a) {
...
buster.spec.describe("test-walker-with-recursive-visitor-fn", function() {
  buster.spec.it("recur over the walk function", function() {
    Uf(vb.a(Jf.a(T([T([1, 2, 3]), T([4, 5])]), Xf), T([T([1, 2, 3]), T([4, 5])])));
    return l
  });
  return l
});
...
p.R = function(a, b, c) {
  return(pa.a ? pa.a("\ufdd0'a", b) : pa.call(l, "\ufdd0'a", b)) ? new Zf(c, this.S, this.O, this.z, l) : (pa.a ? pa.a("\ufdd0'b", b) : pa.call(l, "\ufdd0'b", b)) ? new Zf(this.v, c, this.O, this.z, l) : new Zf(this.v, this.S, this.O, Mb.c(this.z, b, c), l)
};
p.G = function(a, b, c) {
  return Y(b, function(a) {
    return Y(b, $, "", " ", "", c, a)
...
p.R = function(a, b, c) {
  return(pa.a ? pa.a("\ufdd0'a", b) : pa.call(l, "\ufdd0'a", b)) ? new $f(c, this.S, this.O, this.z, l) : (pa.a ? pa.a("\ufdd0'b", b) : pa.call(l, "\ufdd0'b", b)) ? new $f(this.v, c, this.O, this.z, l) : new $f(this.v, this.S, this.O, Mb.c(this.z, b, c), l)
};
p.G = function(a, b, c) {
  return Y(b, function(a) {
    return Y(b, $, "", " ", "", c, a)
...
var bg = function() {
  ...
  function b(a, b, f, h) {
    h = Lb.c(h, 0, l);
    a = Jf.a(b, a);
    return Uf.e(vb.a(a, f), I([[P(t(h) ? [P(h), P(" -- ")].join("") : h), P("expected: "), P(M.e(I([f], 0))), P(" -- "), P("got: "), P(M.e(I([a], 0)))].join("")], 0))
  }
  a.o = 3;
  a.m = function(a) {
    var d = E(a), f = E(H(a)), h = E(H(H(a))), a = F(H(H(a)));
...
buster.spec.describe("test-walk-with-no-rules", function() {
  buster.spec.it("without any rules on visit", function() {
    var a = Ib(K("\ufdd1'let", Fd(["\ufdd1'hello", "hola"]), Ib(K("\ufdd1'str", "\ufdd1'hello"), wb("\ufdd0'line", 12))), wb("\ufdd0'line", 12)), b = Tf(Dd).call(l, ag);
...
buster.spec.describe("test-symbol-as-a-selector", function() {
  buster.spec.it("with symbol as a selector on rules", function() {
    var a = T(["\ufdd1'hello", "\ufdd1'hallo"]), a = Tf(a).call(l, ag);
    bg(a, Ib(K("\ufdd1'let", Fd(["\ufdd1'hello", "hola"]), Ib(K("\ufdd1'str", "\ufdd1'hello"), wb("\ufdd0'line", 13))), wb("\ufdd0'line", 13)), Ib(K("\ufdd1'let", Fd(["\ufdd1'hallo", "hola"]), Ib(K("\ufdd1'str", "\ufdd1'hallo"), wb("\ufdd0'line", 13))), wb("\ufdd0'line", 13)));
    return l
  });
  return l
});
buster.spec.describe("test-function-as-a-selector", function() {
  buster.spec.it("with functions as a selector on rules", function() {
    var a = T([function(a) {
      return Xb(a)
    }, "Something Else"]), a = Tf(a).call(l, ag);
...
buster.spec.describe("test-walking-over-a-set", function() {
  buster.spec.it("with set as the collection we are visiting", function() {
    var a = T(["\ufdd1'foo", 999]), a = Tf(a).call(l, ag);
...
buster.spec.describe("test-vector-as-a-selector", function() {
  buster.spec.it("with vectors as selector on rules", function() {
    var a = T([function(a) {
      return Xb(a)
    }, "\ufdd1'foobar"]), a = T([a, "\ufdd1'replacement"]), a = Tf(a).call(l, ag);
