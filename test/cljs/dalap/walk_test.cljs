...
;;
;; test/clj/dalap/test/walk_test.clj @ Wed Nov 28 00:26:47 UTC 2012
;;
...
(deftest test-walker-state-management (it "manages state correctly" (doseq [st [{} {:a 1234} {:a 1234, :b 99}]] (let [w (-gen-walker identity-visitor st)] (is (= (get-state w) st)) (let [w2 (conj-state w {:c 12})] (is (:c w2) 12) (not= w w2) (walker-equals (update-state w2 (fn* [p1__3766#] (dissoc p1__3766# :c))) w) (walker-equals (update-in-state w :c (fn* [p1__3767#] (do p1__3767# 12))) w2) (walker-equals (conj-state w2 {:d 1, :e 2}) (update-state w2 (fn* [p1__3768#] (conj p1__3768# {:d 1, :e 2})))))))))
