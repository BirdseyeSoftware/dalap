...
;;
;; test/clj/dalap/test/rules_test.clj @ Tue Nov 13 19:54:57 UTC 2012
;;
...
(defn visit-clj-form [form w] (letfn [(filter-map [f form] (remove (fn* [p1__5456#] (= p1__5456# (keyword "dalap/form"))) (map f form)))] (cond (list? form) (apply list (filter-map w form)) (seq? form) (doall (filter-map w form)) (coll? form) (into (empty form) (filter-map w form)) :else form)))
